...
from compare_lstm_transformer import LstmTransformer
...
for fold, (train_ids, val_ids) in enumerate(kfold.split(train_dataset)):
    ...
    model = SimSiam(backbone=LstmTransformer(input_size=x_train.shape[-1], hidden_size=256, num_layers=2, dropout=0.2, out_size=128), backbone_out=128)
