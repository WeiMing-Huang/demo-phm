...
plt.savefig("shap_bar0.8.png",dpi=150, bbox_inches='tight')

shap.summary_plot(shap_squeeze[0], plot_type = 'dot', feature_names = column, show=False)

plt.savefig("shap_dot0.8.png",dpi=150, bbox_inches='tight')
...
importance_df.to_csv('shap0.8.csv', sep=',', index=False, encoding='utf-8')
# %%
