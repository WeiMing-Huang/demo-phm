...
import argparse
import optuna
from compare_gru import GRUNet
...
def objective(trial):
    ...
    model = SimSiam(backbone=GRUNet(**hyperparams), backbone_out=128).to(device)
...
for fold, (train_ids, val_ids) in enumerate(kfold.split(train_dataset)):
    ...
    model = SimSiam(backbone=GRUNet(**hyperparams), backbone_out=128)
