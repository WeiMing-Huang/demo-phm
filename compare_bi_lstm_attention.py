...
class LeNetVariant(nn.Module):
    def __init__(self, out_size=84):
        ...
        self.features = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.MaxPool2d(2, 2))
        self.classifier = nn.Sequential(nn.Linear(1440, 120),
                                        nn.Linear(120, out_size))
...
class CNNLSTM(nn.Module):
    ...
    def forward(self, x_3d):
        ...
        cnn_output_list.append(self.cnn(x_3d[:, :, :, :]))
...
class DPCNN(nn.Module):
    def __init__(self, num_classes, embedding_size):
        ...
        self.conv_region = nn.Conv2d(1, 250, (3, embedding_size), stride=(1,))
