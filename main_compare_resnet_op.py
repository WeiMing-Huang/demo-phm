...
import argparse
import optuna
from compare_resnet import ResNet18
...
def objective(trial):
    ...
    model = SimSiam(backbone=ResNet18(**hyperparams), backbone_out=128).to(device)
...
for fold, (train_ids, val_ids) in enumerate(kfold.split(train_dataset)):
    ...
    model = SimSiam(backbone=ResNet18(**hyperparams), backbone_out=128)
